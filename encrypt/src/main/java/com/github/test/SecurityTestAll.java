...
import com.github.utils.Util;
import com.github.utils.sm2.SM2EncDecUtils;
import com.github.utils.sm2.SM2KeyVO;
import com.github.utils.sm2.SM2SignVO;
import com.github.utils.sm2.SM2SignVerUtils;
...
public class SecurityTestAll {
    ...
    public static void main1(String[] args) throws Exception {
        ...
        String s1 = SM4EncForCBC(sm4Key, src, iv);
        System.out.println("密文:" + s1);
        System.out.println("CBC解密");
        String s2 = SM4DecForCBC(sm4Key, s1, iv);
    ...
    public static void main(String[] args) {
        ...
        String s1 = SM4EncForCBC(sm4Key, src, iv);
        System.out.println("密文:" + s1);
        String text = SM4DecForCBC(sm4Key, s1, iv);
