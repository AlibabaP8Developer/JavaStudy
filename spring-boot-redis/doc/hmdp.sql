...
CREATE TABLE `tb_blog`  (
  ...
  `liked` int(8) UNSIGNED ZEROFILL NULL DEFAULT 00000000 COMMENT '点赞数量',
  `comments` int(8) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '评论数量',
...
CREATE TABLE `tb_blog_comments`  (
  ...
  `liked` int(8) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '点赞数',
  `status` tinyint(1) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '状态，0：正常，1：被举报，2：禁止查看',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `tb_seckill_voucher` VALUES (2, 100, '2022-01-04 10:09:17', '2022-01-04 10:09:17', '2022-01-04 12:09:04', '2022-01-04 10:09:17');
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (1, '13686869696', '', 'user_1fs23a', '', '2021-12-24 10:27:19', '2021-12-24 18:57:39');
INSERT INTO `tb_user` VALUES (2, '13838411438', '', '可可今天不吃肉', '/imgs/icons/kkjtbcr.jpg', '2021-12-24 15:14:39', '2021-12-28 19:58:04');
INSERT INTO `tb_user` VALUES (3, '13438411438', '', 'user_jc0qi0ecj1', '', '2021-12-28 13:13:05', '2021-12-28 13:13:05');
...
CREATE TABLE `tb_voucher_order`  (
  ...
  `pay_type` tinyint(1) UNSIGNED ZEROFILL NOT NULL COMMENT '支付方式 1：余额支付；2：支付宝；3：微信',
